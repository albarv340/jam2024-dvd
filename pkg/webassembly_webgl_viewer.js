...
*/
export function draw_triangle(canvas_id, selected_color) {
    try {
        ...
        wasm.draw_triangle(retptr, ptr0, len0, ptr1, len1);
...
* @returns {WebGLRenderingContext}
*/
export function draw_rectangle(canvas_id, selected_color, size, x, y) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(selected_color) ? 0 : passArrayF32ToWasm0(selected_color, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        wasm.draw_rectangle(retptr, ptr0, len0, ptr1, len1, !isLikeNone(size), isLikeNone(size) ? 0 : size, !isLikeNone(x), isLikeNone(x) ? 0 : x, !isLikeNone(y), isLikeNone(y) ? 0 : y);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('webassembly_webgl_viewer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
